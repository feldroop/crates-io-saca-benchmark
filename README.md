...
All implementations except for `suffix` and `bio` do not need a significant amount of additional memory apart from the suffix array itself. `libsais` provides the fastest implementation. 
